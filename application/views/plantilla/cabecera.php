...
<head>
    ...
    <title>Rani - <?php echo ucfirst($this->router->class); ?></title>
...
<body class="easyui-layout">
    <div data-options="region:'north'" style="height:40px">
        <p class="header">Plataforma Base - <?php echo ucfirst($this->router->class); ?></p>
    </div>
    <div data-options="region:'south'" style="height:40px;">
        <p class="footer">Página mostrada en <strong>{elapsed_time}</strong> segundos</p>
    </div>
    <div data-options="region:'west',hideCollapsedContent:false" title="Menú" style="width:100px;">
    ...
    <div data-options="region:'center',iconCls:'icon-ok'" title="<?php echo ucfirst($this->router->class); ?>" style="padding:4px;background:#eee;">