...
if ($.fn.textbox){
	$.fn.textbox.defaults.missingMessage = 'Este campo es obligatorio.';
	$.fn.textbox.defaults.rules.email.message = 'Por favor ingrese una direcci&oacute;n de correo v&aacute;lida.';
}