...
return cc.join("");
	...
	console.log('refreshRow'+_7ae+_7af);
this.updateRow.call(this,_7ae,_7af,{});
},updateRow:function(_7b0,_7b1,row){
	console.log('entrada de update row'+' '+_7b0+' '+_7b1+' '+row);
	console.log(row);
...
function _7bb(_7bc){
	console.log('entrada de _7bb'+' '+_7bc);
...
console.log('antes de renderRow '+_7b0+' '+_7bd+' '+_7bc+' '+_7b1+' '+rows);
console.log(rows);
...
console.log('antes de _7bb'+' '+_7b0+' '+_7b1+' '+row);
_7bb.call(this,true);
